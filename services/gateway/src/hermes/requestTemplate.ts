  ...
  switch (request.host.platform) {
    case "google_sheets":
      return [
        ...
        "- conditional_format_plan: limited. Supported rule types: single_color, text_contains, number_compare, date_compare, duplicate_values, custom_formula, top_n, average_compare, and color_scale. Conditional numberFormat style is unsupported.",
