...
- data.overwriteRisk is required
- data.confirmationLevel is required
- pivot filters may use equal_to, not_equal_to, greater_than, greater_than_or_equal_to, less_than, less_than_or_equal_to, between, or not_between; every pivot filter requires value, and between and not_between also require value2
